# Kamon
<img align="right" src="https://rawgit.com/kamon-io/Kamon/series/0.7.x/kamon-logo.svg" height="150px" style="padding-left: 20px"/>
...
```scala
libraryDependencies += "kamon.io" %% "kamon-core" % "0.7.0"
```
